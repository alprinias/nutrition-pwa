<template>
  <div class="p-4 space-y-4">
    ...
    <div v-if="selectedDay">
      ...
      <RouterLink
        :to="{ name: 'AddMeal', query: { date: selectedDateKey } }"
        class="btn-primary text-center block mt-3"
      >
...
const selectedDateKey = computed(() =>
  selectedDay.value ? dateKey(viewYear.value, viewMonth.value, selectedDay.value) : ''
)
